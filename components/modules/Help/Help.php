		...
		switch (Language::instance()->clang) {
			case 'uk':
				return '
					...
					<p>Хочеш допомогти ініціативі? - зателефонуй за номером +38 063 117 51 59 або напиши на пошту <a href="mailto:info@opir.org">info@opir.org</a></p>
			...
			case 'ru':
				return '
					...
					<p>Хочешь помочь инициативе? - звони по номеру +38 063 117 51 59 или пиши на почту <a href="mailto:info@opir.org">info@opir.org</a></p>
			...
			default:
				return '
					...
					<p>Want to help initiative? - call +38 063 117 51 59 or write email to <a href="mailto:info@opir.org">info@opir.org</a></p>
