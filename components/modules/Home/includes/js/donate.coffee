		...
		$("""
				<div>
					<div class="uk-form" style="width: 600px;margin-left: -300px;">
						...
						<p>
							Якщо ж у вас немає Bitcoin чи ви не знаєте як ним користуватись - можете поповнити наш гаманець <a href="https://money.yandex.ru/"><u>Яндекс.Деньги</u></a> (є можливість переказати на нього також Webmoney чи поповнити в терміналі як альтернативні відносно анонімні варіанти).
						</p>
						<p>
