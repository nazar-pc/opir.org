		...
		switch (Language::instance()->clang) {
			...
			case 'ru':
				return '
					...
					<p><strong>Сейчас:</strong> мы готовимся к следующим Парламентским выборам и планируем осветить избирательный процесс в максимальном количестве городов Украины. Наша цель - обеспечить каждое отделение для голосования каждого города наблюдателями-стримерами, которые смогут фиксировать нарушения, которые значительно влияют на итог голосования. Результатом станет альтернативный к ЦИК подсчет результатов и отстаивания честных результатов в суде. Такую практику мы призываем проводить в каждом городе, где местная община организуется для такого наблюдения.</p>
