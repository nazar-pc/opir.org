      ...
      success: function(streams) {
        ...
        (function() {
          ...
          for (violation in streams) {
            ...
            results.push(ids.push(violation.precinct));
          }
          return results;
        })();
        ids = ids.join(',');
        return $.ajax({
          ...
          success: function(addresses_districts_loaded) {
            var addresses, content, districts, i, len, precinct, precincts, time, video, violation;
            addresses = {};
            districts = {};
            (function() {
              var i, len, p;
              for (i = 0, len = addresses_districts_loaded.length; i < len; i++) {
                p = addresses_districts_loaded[i];
